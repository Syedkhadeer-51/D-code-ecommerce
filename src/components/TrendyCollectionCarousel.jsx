...
const products = [
    {
        id: 1,
        image: "/assets/trendy-collection-ring.png",
        category: "RINGS",
    ...
    {
        id: 2,
        image: "/assets/trendy-collection-glasses.png",
        category: "EYEWEAR",
        name: "Best UV protection Sunglasses",
        price: "Rs. 3199"
    },
    {
        id: 3,
        image: "/assets/trendy-collection-watch.png",
        category: "WATCHES",
    ...
    {
        id: 4,
        image: "/assets/trendy-collection-chair.png",
        category: "FURNITURE",
        name: "Comfortable recliner chair with table",
        price: "Rs. 6159"
    },
    {
        id: 5,
...
const TrendyCollectionCarousel = () => {
    ...
    return (
        <div className="relative max-w-7xl md:max-w-full mx-auto py-8">
                  <h3 className="text-center text-lg font-medium text-gray-700 mb-6">Trending Collection</h3>
            {/* Carousel */}
                    ...
                    >
                        {extendedProducts.map((item, idx) => (
                            <div key={`${item.id}-${idx}`} className={getWidth()}>
                                <div className="bg-white flex flex-col items-center py-4 px-2">
                                    <img
                                        src={item.image}
                                        alt={item.name}
                                        className="h-46 object-cover mb-2"
                                    />
...
export default TrendyCollectionCarousel;
